...
public class QuestionNineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Title.setText(R.string.title_9);

        ImageView Image = (ImageView) findViewById(R.id.Q_Image);
        Image.setImageResource(R.drawable.i_hirigana_mi);
    ...
    public void nextButton(View view){
        ...
        Intent NQIntent = new Intent(QuestionNineActivity.this, QuestionTenActivity.class);
